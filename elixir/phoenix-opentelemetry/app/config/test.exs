...
config :elixir_phoenix_opentelemetry, ElixirPhoenixOpentelemetry.Repo,
  ...
  password: "postgres",
  hostname: "localhost",
  database: "elixir_phoenix_opentelemetry_test#{System.get_env("MIX_TEST_PARTITION")}",
...
config :elixir_phoenix_opentelemetry, ElixirPhoenixOpentelemetryWeb.Endpoint,
  ...
  secret_key_base: "wEf+BiprlUKKbACsvZ8oQZPUBGYZ2EHxOIIqEAdoK8Sd+lWjeqaihZ52AkhT4x7V",
  server: false
