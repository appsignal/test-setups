...
rake app=elixir/umbrella app:up
...
rake app=ruby/rails7-passenger app:up
...
rake app=nodejs/esbuild-express app:up
rake app=nodejs/express-apollo app:up
rake app=nodejs/express-postgres app:up
rake app=nodejs/express-redis-v2 app:up
rake app=nodejs/express-redis-v3 app:up
rake app=nodejs/koa app:up
rake app=nodejs/next-js app:up
rake app=nodejs/v2 app:up
rake app=nodejs/v3 app:up
...
rake app=elixir/umbrella app:restart
rake app=ruby/hanami app:restart
...
rake app=ruby/rails7-passenger app:restart
...
rake app=nodejs/esbuild-express app:restart
rake app=nodejs/express-apollo app:restart
rake app=nodejs/express-postgres app:restart
rake app=nodejs/express-redis-v2 app:restart
rake app=nodejs/express-redis-v3 app:restart
rake app=nodejs/koa app:restart
rake app=nodejs/next-js app:restart
rake app=nodejs/v2 app:restart
rake app=nodejs/v3 app:restart
...
rake app=elixir/umbrella app:bash
rake app=ruby/hanami app:bash
...
rake app=ruby/rails7-passenger app:bash
...
rake app=nodejs/esbuild-express app:bash
rake app=nodejs/express-apollo app:bash
rake app=nodejs/express-postgres app:bash
rake app=nodejs/express-redis-v2 app:bash
rake app=nodejs/express-redis-v3 app:bash
rake app=nodejs/koa app:bash
rake app=nodejs/next-js app:bash
rake app=nodejs/v2 app:bash
rake app=nodejs/v3 app:bash
...
rake app=elixir/umbrella app:console
rake app=ruby/hanami app:console
...
rake app=ruby/rails7-passenger app:console
...
rake app=nodejs/esbuild-express app:console
rake app=nodejs/express-apollo app:console
rake app=nodejs/express-postgres app:console
rake app=nodejs/express-redis-v2 app:console
rake app=nodejs/express-redis-v3 app:console
rake app=nodejs/koa app:console
rake app=nodejs/next-js app:console
rake app=nodejs/v2 app:console
rake app=nodejs/v3 app:console
...
rake app=elixir/umbrella app:diagnose
rake app=ruby/hanami app:diagnose
...
rake app=ruby/rails7-passenger app:diagnose
...
rake app=nodejs/esbuild-express app:diagnose
rake app=nodejs/express-apollo app:diagnose
rake app=nodejs/express-postgres app:diagnose
rake app=nodejs/express-redis-v2 app:diagnose
rake app=nodejs/express-redis-v3 app:diagnose
rake app=nodejs/koa app:diagnose
rake app=nodejs/next-js app:diagnose
rake app=nodejs/v2 app:diagnose
rake app=nodejs/v3 app:diagnose
...
rake app=elixir/umbrella app:tail:appsignal
rake app=ruby/hanami app:tail:appsignal
...
rake app=ruby/rails7-passenger app:tail:appsignal
...
rake app=nodejs/esbuild-express app:tail:appsignal
rake app=nodejs/express-apollo app:tail:appsignal
rake app=nodejs/express-postgres app:tail:appsignal
rake app=nodejs/express-redis-v2 app:tail:appsignal
rake app=nodejs/express-redis-v3 app:tail:appsignal
rake app=nodejs/koa app:tail:appsignal
rake app=nodejs/next-js app:tail:appsignal
rake app=nodejs/v2 app:tail:appsignal
rake app=nodejs/v3 app:tail:appsignal
