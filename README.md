...
rake app=nodejs/express-redis-v3-alpine app:up
...
rake app=nodejs/express-redis-v3-alpine app:restart
...
rake app=nodejs/express-redis-v3-alpine app:bash
...
rake app=nodejs/express-redis-v3-alpine app:console
...
rake app=nodejs/express-redis-v3-alpine app:diagnose
...
rake app=nodejs/express-redis-v3-alpine app:tail:appsignal
